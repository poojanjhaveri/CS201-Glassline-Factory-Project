...
import gui.panels.subcontrolpanels.NonNormativePanel;
...
//	NonNormPanel nonNormPanel;
	NonNormativePanel nonNormPanel;
	...
	public ControlPanel()
	{
		...
		nonNormPanel = new NonNormativePanel(this);
	 ...
	 */
	public NonNormativePanel getNonNormPanel()
	{
		return nonNormPanel;
	}

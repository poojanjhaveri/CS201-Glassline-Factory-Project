...
public class ConveyorAgent_Y extends Agent implements Conveyor_Y, ConveyorFamily {
	//data
	int conveyorIndex;
	Mode mode;
	...
	private ConveyorAgent_Y () {}
	
	public ConveyorAgent_Y(String n, int index, Mode md) {
		name = n;
		conveyorIndex = index;
		mode = md;
	...
	public void setPopup(Popup_Y p) {
		popup = p;
	}
	
	public void setInline(Inline_Y i) {
		inline = i;
	}
